...
app.get("/project-assign", requireAdmin, async function (req, res, next) {
  ...
  db.execute(read_projects_all_sql, (error, results) => {
    db.execute(getAllScientists, (error, scientistList) => {
      // db.execute(read_scientists_for_project, (error, projectScientists) => {
    
        res.render('project_assign', {results: results, scientists: scientistList});
